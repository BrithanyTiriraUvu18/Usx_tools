...
class SaleWizard(models.TransientModel):
    ...
    def _default_session(self):
        return self.env['academy.session'].browse(self.env.context.get('active_id'))
    ...
    def create_sale_orders(self): 
        session_product_id=self.env['product.product'].search([('is_session_product', '=', True)],limite=1)    
